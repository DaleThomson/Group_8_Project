...
Shader "Character"
{
	Properties
	{
		...
		_MS("MS", 2D) = "white" {}
		[ASEEnd]_Saturation("Saturation", Range( 0 , 1)) = 0.9
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float dotResult12 = dot( tex2DNode9 , float4( float3(0.2126729,0.7151522,0.072175) , 0.0 ) );
				float4 temp_cast_1 = (dotResult12).xxxx;
				float4 lerpResult16 = lerp( temp_cast_1 , tex2DNode9 , _Saturation);
				
				float2 uv_Normal = IN.ase_texcoord7.xy * _Normal_ST.xy + _Normal_ST.zw;
				
				float2 uv_MS = IN.ase_texcoord7.xy * _MS_ST.xy + _MS_ST.zw;
				float4 tex2DNode10 = tex2D( _MS, uv_MS );
...
/*ASEBEGIN
Version=18935
-308.4445;1066.667;1706.667;939;702.3333;491.8333;1;True;True
Node;AmplifyShaderEditor.SamplerNode;9;-336.3333,-406.8333;Inherit;True;Property;_Albedo;Albedo;1;0;Create;True;0;0;0;False;0;False;-1;1280b2e7c28945a4aac3c032665bde5c;1280b2e7c28945a4aac3c032665bde5c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector3Node;15;-288.3333,-171.8333;Inherit;False;Constant;_Vector0;Vector 0;4;0;Create;True;0;0;0;False;0;False;0.2126729,0.7151522,0.072175;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DotProductOpNode;12;-10.33331,-219.8333;Inherit;False;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-40.33331,-27.83334;Inherit;False;Property;_Saturation;Saturation;3;0;Create;True;0;0;0;False;0;False;0.9;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;8;-426.3333,6.166656;Inherit;True;Property;_Normal;Normal;0;0;Create;True;0;0;0;False;0;False;-1;f0c09576b6d07854192c900cf9a0a93d;f0c09576b6d07854192c900cf9a0a93d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-40.33331,137.1667;Inherit;True;Property;_MS;MS;2;0;Create;True;0;0;0;False;0;False;-1;cc9f150e42f1a9148937ae564f7114b2;cc9f150e42f1a9148937ae564f7114b2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;16;291.6667,-217.8333;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=861C3F55483B51B0A826B89D945547AA2625502D