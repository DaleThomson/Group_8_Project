	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_MR = IN.ase_texcoord7.xy * _MR_ST.xy + _MR_ST.zw;
				float4 tex2DNode10 = tex2D( _MR, uv_MR );
				...
				float Smoothness = ( 1.0 - tex2DNode10.a );
				float Occlusion = 1;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
0;1072.667;1707;933;875.4998;274.5;1;True;True
Node;AmplifyShaderEditor.SamplerNode;10;-335.3333,354.5;Inherit;True;Property;_MR;MR;2;0;Create;True;0;0;0;False;0;False;-1;4c95f2c5ce8bf4a4a8f9f8ccb0f1f2fa;4c95f2c5ce8bf4a4a8f9f8ccb0f1f2fa;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=BFDC2590555CC69ABCAC8949AB5C4A1F4EAE9D28